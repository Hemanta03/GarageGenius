...
<div>
    <a href="${pageContext.request.contextPath}/admin/messages">Inbox</a> |
    <a href="${pageContext.request.contextPath}/admin/messages?action=sent">Sent</a> |
    <a href="${pageContext.request.contextPath}/admin/messages?action=compose">Compose</a>
</div>
<br>
...
<table border="1">
    ...
    <c:forEach var="m" items="${messages}">
        <tr>
            ...
            <td>
                <a href="${pageContext.request.contextPath}/admin/messages?action=view&id=${m.messageId}">View</a>
